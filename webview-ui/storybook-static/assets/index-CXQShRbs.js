		...
		Me ||
			...
			(function (n, a) {
				;(function (o, i) {
					...
					function X(e) {
						var t, r
						return (r = (t = D.exec(e)) === null || t === void 0 ? void 0 : t[0]) !== null && r !== void 0
							? r
							: null
					}
					const Q = (e) => {
					...
					function fe({ allowSquaredProperties: e, allowKeyTypes: t, allowReadonly: r, allowOptional: s }) {
						return g({
					...
					const Le = [
						...
						zt = [
							...
							$,
							Z,
							fe({ allowSquaredProperties: !1, allowKeyTypes: !1, allowOptional: !1, allowReadonly: !1 }),
						],
						Zt = [
							...pe,
					...
					const nn = g({
						...
						ln = g({
							...
							parseInfix: (e, t) => {
								...
								return (
									e.consume("is"),
									{ type: "JsdocTypePredicate", left: t, right: w(e.parseIntermediateType(f.INFIX)) }
								)
							},
						}),
						cn = g({
						...
						pn = [
							...
							$,
							Z,
							fe({ allowSquaredProperties: !0, allowKeyTypes: !1, allowOptional: !0, allowReadonly: !0 }),
							cn,
						],
						un = [
							...pe,
					...
					const Jn = {
						...
						JsdocTypeObjectField: (e, t) => {
							...
							return (
								e.optional &&
									(r = { type: "OPTIONAL", value: r, meta: { syntax: "SUFFIX_KEY_QUESTION_MARK" } }),
								{
									type: "RECORD_ENTRY",
									key: e.key.toString(),
									quoteStyle: L(e.meta.quote),
...
function st(n = "compact") {
	...
	return (o) => {
		...
		for (let [m, { tokens: h }] of o.source.entries()) {
			...
			for (let N of h.description) if ((N === "{" && i++, N === "}" && i--, (b += N), i === 0)) break
		...
		for (let [m, [h, b]] of p.entries())
			(h.type = b),
				m > 0 && ((h.type = h.postDelimiter.slice(y) + b), (h.postDelimiter = h.postDelimiter.slice(0, y))),
...
function lt() {
	...
	return (a) => {
		...
		if (p.length > 1 && p[0] === "" && p.length % 2 === 1)
			return (a.name = p[1]), (o.name = `"${p[1]}"`), ([o.postName, o.description] = j(i.slice(o.name.length))), a
		let u = 0,
			y = "",
			m = !1,
			h
...
function Nt(n) {
	let a = ve(n.type)
	return a ? { type: a, description: be(n.name, n.description), getTypeName: l(() => Se(a), "getTypeName") } : null
}
l(Nt, "extractReturns")
...
var Gn = l((n, a) => {
	...
	return { name: n, type: Ot(o), required: p, description: i, defaultValue: bt(u ?? null, o ?? null) }
}, "createFlowPropDef")
...
function At({ tsType: n, required: a }) {
	if (n == null) return null
	let o = n.name
	return a || (o = o.replace(" | undefined", "")), E(["Array", "Record", "signature"].includes(n.name) ? n.raw : o)
}
l(At, "createType")
var Wn = l((n, a) => {
...
var Xn = l((n, a, o) => {
	...
	Ut = l(
		(n) =>
			n.type != null ? "JavaScript" : n.flowType != null ? "Flow" : n.tsType != null ? "TypeScript" : "Unknown",
		"getTypeSystem",
	),
	Zn = l((n) => {
		let a = Ut(n[0]),
...
export { ke as B, We as Y, Et as a, sr as c, ar as g, Ln as j, E as l, tr as n, or as o, ir as y, Ne as z }
