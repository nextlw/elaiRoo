...
function rt(e) {
	...
	;(o = o + d.window.scrollY), (l = l + d.window.scrollX), (n = n + d.window.scrollY), (i = i + d.window.scrollX)
...
function st(e, { padding: t, border: o, width: l, height: i, top: n, left: r, bottom: f, right: a }) {
