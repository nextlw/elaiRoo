try {
	;(() => {
		...
		function L(e, t) {
			...
			if (e && t && (r = e.constructor) === t.constructor) {
				...
				if (r === Set) {
					...
					for (n of e)
						if (((a = n), (a && typeof a == "object" && ((a = Fe(t, a)), !a)) || !t.has(a))) return !1
					return !0
				}
				if (r === Map) {
					if (e.size !== t.size) return !1
					for (n of e)
						if (((a = n[0]), (a && typeof a == "object" && ((a = Fe(t, a)), !a)) || !L(n[1], t.get(a))))
							return !1
					return !0
				}
		...
		function It(e, t) {
			if (t === "transparent") return t
			var r = A(t)
			return C(_({}, r, { lightness: M(0, 1, r.lightness - parseFloat(e)) }))
		}
		var gl = v(It)
		function Mt(e, t) {
			if (t === "transparent") return t
			var r = A(t)
			return C(_({}, r, { saturation: M(0, 1, r.saturation - parseFloat(e)) }))
		}
		var hl = v(Mt)
		function Dt(e, t) {
			if (t === "transparent") return t
		...
		function Ft(e, t) {
			...
			var r = I(t),
				...
				a = _({}, r, { alpha: M(0, 1, (n * 100 + parseFloat(e) * 100) / 100) })
			return $(a)
		}
		var Ht = v(Ft),
			qe = Ht
		...
		function Vt(e, t) {
			...
			var r = I(t),
				n = typeof r.alpha == "number" ? r.alpha : 1,
				a = _({}, r, { alpha: M(0, 1, +(n * 100 - parseFloat(e) * 100).toFixed(2) / 100) })
			return $(a)
		}
		var Rl = v(Vt)
		var $t = "actions",
